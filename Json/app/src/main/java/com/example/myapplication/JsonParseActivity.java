...
public class JsonParseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Figure");
    ...
    private String getListData() {
        String jsonStr = "{ \"users\" :[" +
                "{\"name\":\"Gojo Satoru\",\"designation\":\"Leader\",\"location\":\"East Java\"}" +
                ",{\"name\":\"Yuji Itadori\",\"designation\":\"Co-Leader\",\"location\":\"East Java\"}" +
                ",{\"name\":\"Megumi Fushiguro\",\"designation\":\"Navigator\",\"location\":\"East Java\"}" +
                ",{\"name\":\"Nobara Kugisaki\",\"designation\":\"Navigator\",\"location\":\"East Java\"}] }";
        return jsonStr;
    }
}
